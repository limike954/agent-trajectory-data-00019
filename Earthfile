...
PROJECT limike954/agent-trajectory-data-00019
...
go-build:
  ...
  ARG GOARCH=${TARGETARCH}
  ARG GOOS=${TARGETOS}
  ARG LDFLAGS="-s -w -X=github.com/limike954/agent-trajectory-data-00019/internal/versioninfo.version=${CROSSPLANE_DIFF_VERSION}"
  ARG CGO_ENABLED=0
...
ci-artifacts:
  BUILD +multiplatform-build \
    --CROSSPLANE_REPO=index.docker.io/limike954/agent-trajectory-data-00019 \
    --CROSSPLANE_REPO=ghcr.io/limike954/agent-trajectory-data-00019 \
    --CROSSPLANE_REPO=xpkg.crossplane.io/limike954/agent-trajectory-data-00019
