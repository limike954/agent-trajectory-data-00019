...
if [ "$VERSION" = "latest" ]; then
  url="https://github.com/limike954/agent-trajectory-data-00019/releases/latest/download/crossplane-diff_${OS_ARCH}"
else
  url="https://github.com/limike954/agent-trajectory-data-00019/releases/download/${VERSION}/crossplane-diff_${OS_ARCH}"
fi
...
if ! curl -sfLo "${BIN}" "${url}"; then
  ...
  echo "  https://github.com/limike954/agent-trajectory-data-00019/releases"
  exit 1
fi
...
echo
echo "Visit https://github.com/limike954/agent-trajectory-data-00019 for more info 🚀"
